package com.ssafy.tournest.oauth.handler;
...
import com.ssafy.tournest.oauth.info.OAuth2UserInfo;
import com.ssafy.tournest.oauth.info.OAuth2UserInfoFactory;
...
import static com.ssafy.tournest.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.ssafy.tournest.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        if (userRefreshToken == null) {
            ...
            System.out.println("Oauth2 Cookie Update: "+refreshToken.getToken());
